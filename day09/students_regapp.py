...
from tkinter.font import * # 기본의 폰트를 사용하려면 
...
ent1.config(state='readonly', foreground='blue', disabledforeground='blue') # 값을 입력못하게
...
# 4-5 트리뷰 설정
for col in cols:
    dataView.heading(col, text=col)                 # 각 열의 제목을 cols 변수 하나씩 지정
